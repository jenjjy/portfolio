        ...
        <section className="about-content-wrapper">
          ...
          <div className="text-wrapper">
            ...
            <p className="text">
              ...
              website using HTML. I’ve decided to pursue this passion by
              completing a Diploma in FullStack Development where I helped build
              industry quality websites and applications.
            </p>
            <p className="text">
